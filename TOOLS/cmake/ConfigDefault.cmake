#
# ConfigDefault.cmake 11782 2013-06-23 18:10:30Z pwessel
#
...
#-------------------------------------------------------------------------------
#
# Default gsfml settings. DO NOT EDIT THIS FILE!
#
...
# The gsfml package name.
set (GSFML_PACKAGE_NAME "gsfml")

# a short description of the custom project (only a few words).
set (GSFML_PACKAGE_DESCRIPTION_SUMMARY "GSFML Extension to The Generic Mapping Tools")

# The GSFML package version.
set (GSFML_PACKAGE_VERSION_MAJOR "1")
set (GSFML_PACKAGE_VERSION_MINOR "0")
set (GSFML_PACKAGE_VERSION_PATCH "6")

# The subversion revision of the gsfml source code.
# This is manually set when making GSFML *public* releases.
...
#set (GSFML_SOURCE_CODE_CONTROL_VERSION_STRING "9047")

# The GSFML package version.
set (GSFML_PACKAGE_VERSION "${GSFML_PACKAGE_VERSION_MAJOR}.${GSFML_PACKAGE_VERSION_MINOR}.${GSFML_PACKAGE_VERSION_PATCH}")

# GSFML_VERSION_YEAR set to current date in cmake/modules/ConfigCMake.cmake
# if not specified here:
#set (GSFML_VERSION_YEAR "2023")

# Directory in which to install the release sources per default
if (NOT DEFINED GSFML_RELEASE_PREFIX)
	set (GSFML_RELEASE_PREFIX ${GSFML_BINARY_DIR}/GSFML-${GSFML_PACKAGE_VERSION}-src)
endif (NOT DEFINED GSFML_RELEASE_PREFIX)


# The GSFML copyright - string version to be used in a source file.
set (GSFML_COPYRIGHT_STRING)
set (GSFML_COPYRIGHT_STRING "${GSFML_COPYRIGHT_STRING}Copyright 1991-${GSFML_VERSION_YEAR} The list of authors\\n")
set (GSFML_COPYRIGHT_STRING "${GSFML_COPYRIGHT_STRING}This program comes with NO WARRANTY, to the extent permitted by law.\\n")
set (GSFML_COPYRIGHT_STRING "${GSFML_COPYRIGHT_STRING}You may redistribute copies of this program under the terms of the\\n")
set (GSFML_COPYRIGHT_STRING "${GSFML_COPYRIGHT_STRING}GNU General Public License.\\n")
set (GSFML_COPYRIGHT_STRING "${GSFML_COPYRIGHT_STRING}For more information about these matters, see the file named LICENSE.TXT.\\n")
set (GSFML_COPYRIGHT_STRING "${GSFML_COPYRIGHT_STRING}\\n")
