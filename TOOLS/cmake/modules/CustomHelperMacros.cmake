#
# $Id: CustomHelperMacros.cmake 11761 2013-06-21 16:27:41Z pwessel $
#
# - Useful CMake macros
#
...
if(NOT DEFINED _CUSTOM_HELPER_MACROS_CMAKE_)
	set(_CUSTOM_HELPER_MACROS_CMAKE_ "DEFINED")
	...
	macro (ADD_DEPEND_TO_TARGET _TARGET)
		if(NOT TARGET ${_TARGET})
			add_custom_target (${_TARGET}
				WORKING_DIRECTORY ${CUSTOM_BINARY_DIR})
	...
	macro (INSTALL_MODULE_SYMLINK)
		if (WIN32 AND DO_INSTALL_MODULE_LINKS)
			...
			foreach (_custommodule ${ARGV})
				add_executable (${_custommodule} ${CUSTOM_PROGRAM})
				string (TOUPPER "${_custommodule}" UCASEname)
				set_target_properties (${_custommodule} PROPERTIES
					COMPILE_DEFINITIONS "MODULE=\"${_custommodule}\""
					LINK_FLAGS " /MANIFEST:NO")
				target_link_libraries (${_custommodule} customlib)
			endforeach (_custommodule)
			...
			add_depend_to_target (custom_module_progs ${ARGV})
		elseif (UNIX AND DO_INSTALL_MODULE_LINKS)
			# create custom module symlinks to gmt
			#get_target_property(CUSTOM_MAIN_NAME gmt OUTPUT_NAME)
			file (RELATIVE_PATH _rpath /bin /${CUSTOM_BINDIR}/${CUSTOM_MAIN_NAME})
			foreach (_custommodule ${ARGV})
				install (CODE "
				execute_process (COMMAND ${CMAKE_COMMAND} -E remove -f
					\$ENV{DESTDIR}\${CMAKE_INSTALL_PREFIX}/${CUSTOM_BINDIR}/${_custommodule})
				execute_process (COMMAND ${CMAKE_COMMAND} -E create_symlink
					${_rpath} \$ENV{DESTDIR}\${CMAKE_INSTALL_PREFIX}/${CUSTOM_BINDIR}/${_custommodule})
				" COMPONENT Runtime)
			endforeach (_custommodule)
		endif (WIN32 AND DO_INSTALL_MODULE_LINKS)
	endmacro (INSTALL_MODULE_SYMLINK)

endif(NOT DEFINED _CUSTOM_HELPER_MACROS_CMAKE_)
